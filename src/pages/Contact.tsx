  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          access_key: "904c717c-d8f9-46e9-9d64-2cb4325f819f", // User needs to replace this
          name: formData.name,
              ...
              <Card className="p-8">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="bg-secondary/10 p-4 rounded-lg hover:bg-secondary/20 transition-colors"
                  >
