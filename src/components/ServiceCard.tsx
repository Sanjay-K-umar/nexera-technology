...
export function ServiceCard({ icon, title, description, services, link, href, delay = '0s' }: ServiceCardProps) {
  const url = link || href || '#'
      ...
      <Link href={url} className="block h-full">
        <Card className="p-8 h-full hover:shadow-2xl transition-all duration-300 hover:scale-105 group border-2 hover:border-primary bg-card">
          <div className="flex flex-col h-full">
            ...
            <div className="flex items-center text-primary font-semibold group-hover:gap-2 transition-all text-lg mt-auto">
              Learn More
